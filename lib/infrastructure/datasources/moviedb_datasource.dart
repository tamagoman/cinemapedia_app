...
class MoviedbDatasource extends MoviesDatasource{
  ...
  List<Movie> _jsonToMovies( Map<String, dynamic> jsonData) {
    ...
    final List<Movie> movies = movieDBResponse.results
      .where((moviedb) => moviedb.posterPath != 'no-poster')  //ONLY MOVIES WITH POSTER
      .map(
  ...
  Future<Movie> getMovieById(String id) async {
    ...
    final Movie movie = MovieMapper.movieDetailsToEntity( MovieDetails.fromJson(response.data) );
